...
public:
	...
	void WriteMetaFile(const int& grid_size, const std::vector<sf::Vector2i>& point_pos, const int& length, const int& num_turns);
	

	//split up
	sf::VertexArray* SplitTrackImage(const int& grid_size, sf::VertexArray& vertexarray, sf::VertexArray& vertexarray1, sf::VertexArray& vertexarray2, sf::VertexArray& vertexarray3);
	sf::VertexArray* SplitImage(const int& grid_size, sf::VertexArray& vertexarray, sf::VertexArray& vertexarray1, sf::VertexArray& vertexarray2, sf::VertexArray& vertexarray3);
private:
