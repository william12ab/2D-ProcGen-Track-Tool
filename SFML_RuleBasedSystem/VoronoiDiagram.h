...
public:
	...
	void SetPointOnEdgeHeight(bool& found_, int& counter_, const int& chunk_index, std::default_random_engine gen_, std::uniform_int_distribution<int> dist_, const int&x_pos_changed,int&y_pos_changed);
